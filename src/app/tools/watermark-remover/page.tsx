      ...
      >
        <div className="relative isolate overflow-hidden bg-background px-6 py-12 text-center sm:px-16 sm:py-24 rounded-2xl shadow-xl">
            ...
            <div className="mx-auto max-w-2xl space-y-6">
                ...
                This advanced AI tool is under development. It will allow you to magically remove unwanted watermarks from your images, restoring them to a clean, original state. Check back soon!
                </p>
